final soup = <Map<String, dynamic>>[
  {
    ...
    'steps': [
      {'step': 'سخني زيت الزيتون في وعاء.'},
      {'step': 'أضيفي البصل والثوم واقليهما.'},
      {'step': 'أضيفي الخضروات الأخرى.'},
      {'step': 'أضيفي مرق الخضار.'},
      {'step': 'اطهي المزيج حتى ينضج.'},
      {'step': 'أضيفي الطماطم المهروسة.'},
      {'step': 'تبلّي حسب الرغبة.'},
      {'step': 'قدمي الشوربة ساخنة.'}
    ]
  },
  {
    'level': 'سهل',
